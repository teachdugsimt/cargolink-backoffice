...
import { AtlassianNavigation, ProductHome, Profile } from '@atlaskit/atlassian-navigation';
  ...
  return (
    <>
      <AtlassianNavigation
        ...
        renderProductHome={() => <img src={images.cargolinkLogo} style={{ maxWidth: 200, height: 'auto' }} />}
