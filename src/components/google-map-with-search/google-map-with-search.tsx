...
export const GoogleMapWithSearch = (props: PropsGoogleMap) => {
  ...
  const [{ address, city, area, state, mapPosition, markerPosition }, setState] = useState(initialState);
  ...
  useEffect(() => {
    ...
    check_update++;
  }, [address, city, area, state, JSON.stringify(markerPosition), JSON.stringify(center)]);
      ...
      <div>
        <div>
          <div className="form-group">
            <span>{t('City')}</span>
            <input type="text" name="city" className="form-control" onChange={onChange} readOnly={true} value={city} />
          </div>
          <div className="form-group">
            <span>{t('Area')}</span>
            <input type="text" name="area" className="form-control" onChange={onChange} readOnly={true} value={area} />
          </div>
          <div className="form-group">
            <span>{t('State')}</span>
            <input
