...
export default class HTML extends React.Component {
  render() {
    ...
    const addScript =
      `<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD_xZbQQVruH1NWLqCE2kgSWBPoWH7l3Sw"></script>` +
    ...
    return (
      <html {...this.props.htmlAttributes}>
        ...
        <body {...this.props.bodyAttributes}>
          ...
          <div key={`body`} id="___gatsby" dangerouslySetInnerHTML={{ __html: addScript }} />
