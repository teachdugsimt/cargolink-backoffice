...
context('Actions', () => {
  ...
  it('.type() - type into a DOM element', () => {
    ...
    cy.get('.action-email', { delay: 500 })
      .type('fake@email.com')
      .should('have.value', 'fake@email.com', { delay: 500 })

      // .type() with special character sequences
      .type('{leftarrow}{rightarrow}{uparrow}{downarrow}', { delay: 500 })
      .type('{del}{selectall}{backspace}', { delay: 500 })

      // .type() with key modifiers
      .type('{alt}{option}', { delay: 500 }) //these are equivalent
      .type('{ctrl}{control}', { delay: 500 }) //these are equivalent
      .type('{meta}{command}{cmd}', { delay: 500 }) //these are equivalent
      .type('{shift}')

      // Delay each keypress by 0.1 sec
      .type('slow.typing@email.com', { delay: 1000 })
      .should('have.value', 'slow.typing@email.com', { delay: 500 });
